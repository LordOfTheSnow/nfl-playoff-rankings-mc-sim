...
- Simulation runs as a background job with live progress (current phase, e.g. "Ranking impact games… (312/876)") and a Cancel button for stopping a long run early
